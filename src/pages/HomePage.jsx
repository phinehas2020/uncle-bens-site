  ...
  return (
    <>
      ...
      <section className="section bg-slate-50 relative isolate overflow-hidden">
        <div className="absolute top-0 right-0 -m-32 w-[600px] h-[600px] bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px] pointer-events-none" />
        <div className="site-container relative z-10">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <p className="subtle-badge mb-6">Expert Services</p>
            <h2 className="text-4xl sm:text-5xl font-bold font-serif text-slate-900 tracking-tight">Core services for <span className="text-accent italic font-normal">Austin-area moves</span>.</h2>
